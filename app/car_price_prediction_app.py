...
@st.cache_resource
def load_model():
    with open(r"D:\Policia\Projects\CarPricePrediction\saved_models\RandomForestRegressor.pkl", 'rb') as f:
        model= pickle.load(f)
    
    with open(r"D:\Policia\Projects\CarPricePrediction\saved_scaling\scaler.pkl", 'rb') as f:
